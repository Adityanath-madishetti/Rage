...
namespace Rage
{
  ...
  class Argument{
    ...
    public:
    //constructor;
    Argument(std::string name,std::string longname,char shortname, Rage::ArgType type,std::string default_value, bool is_variadic=false,bool is_positional=false,bool required=true,std::string short_help_msg){
      this->name=name;
      ...
      this->short_help=short_help_msg;
    }
  ...
  // exposed to user
        ...
        class Flag {
              ...
              public:
                      ...
                      Flag(std::string name,std::string long_name,char short_name,Rage::ArgType type ,std::string short_help_msg, std::string default_value,bool is_variadic=false,bool arg_req=true){
                        this->name=name;
